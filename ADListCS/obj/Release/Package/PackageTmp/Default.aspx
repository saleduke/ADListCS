<%@ Page Title="Schneider Electric DMS NS" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
...
<head id="Head1" >
	<title>Schneider Electric DMS NS PhoneBook</title> 
...
<div style="padding-top: 0.5em;padding-left: 0.5em;padding-bottom: 0.5em; text-align:left">
	...
	left: 2em; text-align:left" BorderWidth="1" BorderColor="#999999" BorderStyle="Ridge"  Width="300">
		   ...
		   <asp:Table ID="Table1"  CellPadding="5" CellSpacing="5" style="color: #000000;background-color: #089642;padding-top: 0.5em;padding-left: 0.5em;
	font-family: Arial, Verdana, Tahoma;
	font-size:16px;
	font-weight:normal;
	...
	left: 2em; text-align:left" BorderWidth="1" BorderColor="#999999" BorderStyle="Ridge" Width="300" runat="server">
			...
			<asp:Table ID="Table2"  CellPadding="5" CellSpacing="5" style="color: #000000;background-color: #089642;padding-top: 0.5em;padding-left: 0.5em;
	font-family: Arial, Verdana, Tahoma;
	font-size:16px;
	font-weight:normal;
