<%@ Page Title="Schneider Electric DMS NS Offices" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="office.aspx.cs" Inherits="ADListCS.office" EnableEventValidation="false" %>
...
<asp:ServiceReference Path="~/AutoCompleteCS.asmx" />
	...
	left: 2em;text-align:left" BorderWidth="1" BorderColor="#999999" BorderStyle="Ridge">
		...
		<asp:TableRow ID="TableRow8" runat="server">
		 ...
		 <asp:Label ID="Label1" runat="server" Text="People" ForeColor="#089642" 
