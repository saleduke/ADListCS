<%@ Page Title="Execom PhoneBook" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PhoneBook.aspx.cs" Inherits="ADListCS.PhoneBook" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <form id="form1" action="PhoneBook.aspx" >
	...
	<asp:Table ID="Table4" runat="server" Visible="True" CellPadding="5" CellSpacing="5" style="text-align:left">
		...
		<asp:TableCell ID="TableCell18" runat="server" ><asp:Table ID="Table2" runat="server"  BorderColor="#FFCCCC" 
			BorderStyle="Ridge" BorderWidth="2px" CellPadding="5" CellSpacing="5" BackColor="#CCAAAA">
		<asp:TableRow ID="TableRow9" runat="server">
		  ...
		  <asp:TableRow ID="TableRowDepartment" runat="server">
				<asp:TableCell ID="TableCell23" runat="server">
					<asp:LinkButton ID="LinkButtondepartment" runat="server" ForeColor="#EA4E51" Font-Underline="False" style="font-family: Arial,sans-serif;font-size: 10px;line-height: 1.4;margin: 0pt;padding: 0pt;"></asp:LinkButton>
					</asp:TableCell>
			</asp:TableRow>
		...
		<asp:LinkButton ID="LinkButton1" runat="server" ForeColor="#EA4E51" Font-Underline="False"></asp:LinkButton><asp:Label ID="Label42" runat="server" style="color: #555555;font-family: Arial,sans-serif;font-size: 10px;line-height: 1.4;margin: 0pt;padding: 0pt; vertical-align:text-top" Visible="false"></asp:Label></asp:TableCell></asp:TableRow>
		...
		<asp:TableCell ID="TableCell30" runat="server" ><asp:Label ID="Label6" runat="server" Text="Organizational hierarchy" ForeColor="#EA4E51" Font-Bold="False" Font-Names="Arial,Verdana,Tahoma" Font-Size="18pt"></asp:Label></asp:TableCell>
		</asp:TableRow>
